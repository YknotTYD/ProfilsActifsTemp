...
class Role(models.Model):
    ...
    #: dans le journal de consultation d'un candidat (RGPD art. 15) : on lui
    #: dit quelle organisation a consulte son profil, jamais quelle personne
    #: physique. Facultatif : un compte sans organisation apparait sous un
    #: libelle neutre.
