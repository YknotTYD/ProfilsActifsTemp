...
def profile_page(request, username):
    ...
    # Meme reponse 404 neutre dans les trois cas : nom inexistant, profil
    # prive, profil retire du catalogue (RGPD art. 21). `can_view_profile`
    # porte deja la regle du retrait, si bien que comparer deux reponses ne
    # revele pas qu'une personne etait inscrite.
